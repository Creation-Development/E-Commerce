    ...
    return (
        <>
            ...
            <Container>
                ...
                <Card className="shadow" style={{height:610, width:1010, marginLeft:150}}>
                    <Chart
                        width={'800px'}
                        height={'100px'}
                        chartType="BarChart"
                        ...
                        data={[
                            ...
                            ['Electronics Products  ', `${electronic.length}`, 'yellow', null],
                            ['Assesories Products  ', `${assesories.length}`, 'green', null],
                        ]}
                        options={{
